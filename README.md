...
## RESTfull API состоит из файлов:
- [index.php](https://github.com/pllano/api-json-db/blob/master/index.php) - Основной файл содержащий конфигурацию
- [router.php](https://github.com/pllano/api-json-db/blob/master/router.php) - отвечает за роутинг HTTP запросов
- [.htaccess](https://github.com/pllano/api-json-db/blob/master/.htaccess) - Вспомагательный файл настроек
