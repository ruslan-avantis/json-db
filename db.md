...
-------
При первом запуске в папке `_db_` которую вы указали при запуске база создаст:   
...
Для автоматического создания всех необходимых таблиц отредактируйте файл `db.json` и скопируйте его в директорию `/www/_db_/core/`
