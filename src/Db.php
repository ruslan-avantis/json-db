...
class Db {
    ...
    */
    ...
    public function run()
    {
        ...
        define('JSON_DB_DIR_TEMP', str_replace('db.', $this->bd_path, $this->dir_temp));
        ...
        define('JSON_DB_DIR_REQUEST', str_replace('db.', $this->bd_path, $this->dir_request));
        ...
        try {
            jsonDb::table('db')->find(1);} catch(dbException $e){
        ...
        if (!file_exists(JSON_DB_DIR_CORE.'/db.json')){
            if (isset($this->structure)) {
                ...
                file_put_contents(JSON_DB_DIR_CORE.'/db.json', file_get_contents('https://raw.githubusercontent.com/pllano/db.json/master/db.json'));
            }
        }
